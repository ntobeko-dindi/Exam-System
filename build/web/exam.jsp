...
<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
    <div class="sidebar-background" >
        ...
        <div class="left-menu">
            <a  href="std-page.jsp?pgprt=0"><h2>My Profile</h2></a>
            <a class="active" href="std-page.jsp?pgprt=1"><h2>Tests</h2></a>
...
<div class="content-area">
    ...
    <form id="myform" action="controller.jsp">
        ...
        <center>
            ...
            %>
            <div class="panel form-style-6" style="float: left;min-width: 90%; padding-top: 40px;">
                <div class="title" style="margin-top: -60px;">Select Test to Take</div>
                <br/>
                ...
                <form action="controller.jsp">
                    ...
                    <input type="submit" value="Take Test" class="form-button">
                </form>
